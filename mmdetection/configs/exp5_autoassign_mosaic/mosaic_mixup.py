...
class Mosaic_p:
    ...
    def _mosaic_transform(self, results):
        ...
        for i, loc in enumerate(loc_strs):
            if loc == 'top_left':
                ...
                results_patch = copy.deepcopy(
                    results['mix_results'][i - 1])
    ...
    def _mosaic_combine(self, loc, center_position_xy, img_shape_wh):
        ...
        """
        assert loc in ('top_left', 'top_right',
...
class MixUp_p:
    ...
    def _mixup_transform(self, results):
        ...
        # 2. paste
        out_img[:retrieve_img.shape[0],
                :retrieve_img.shape[1]] = retrieve_img
        ...
        retrieve_gt_bboxes[:,
                           0::2] = retrieve_gt_bboxes[:, 0::2] * scale_ratio
        retrieve_gt_bboxes[:,
                           1::2] = retrieve_gt_bboxes[:, 1::2] * scale_ratio
        if self.bbox_clip_border:
        ...
        inside_inds = find_inside_bboxes(
            mixup_gt_bboxes, target_h, target_w)
